...
using EclarinManaloPolicarpio.Filters;
using EclarinManaloPolicarpio.Models;
using System.Net.Mail;

namespace EclarinManaloPolicarpio.Controllers
{
    [Authorize]
...
public ActionResult ForgotPassword(string UserName)
{
    ...
    return View();
        ...
        private void SendEMail(string emailid, string subject, string body)
        {
            ...
            System.Net.NetworkCredential credentials = new System.Net.NetworkCredential("samantha122095@gmail.com", "csjlarribaletran");
            client.UseDefaultCredentials = false;
            client.Credentials = credentials;

            System.Net.Mail.MailMessage msg = new System.Net.Mail.MailMessage();
            msg.From = new MailAddress("samantha122095@gmail.com");
